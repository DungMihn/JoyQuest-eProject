    ...
    <div>
      ...
      >
        ...
        <div className="absolute flex w-full bottom-[-30%] flex-col md:flex-row gap-4 justify-center">
          {/* Email Card */}
          <div className="group hidden  md:flex flex-col w-[90%] md:w-[350px] h-[200px] bg-white shadow-lg rounded-lg p-6 transition-transform hover:-translate-y-2 duration-500 hover:bg-orangeCustom hover:text-white">
