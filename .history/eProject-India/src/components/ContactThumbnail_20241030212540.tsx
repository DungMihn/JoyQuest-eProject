  ...
  return (
    <div>
      ...
      >
        ...
        <div className="absolute flex w-full bottom-[-30%] flex-col md:flex-row gap-4 justify-center md:bottom-0">
          {/* Email Card */}
          <div className="hidden md:flex group flex-col w-[90%] md:w-[350px] h-[200px] bg-white shadow-lg rounded-lg p-6 transition-transform hover:-translate-y-2 duration-500 hover:bg-orangeCustom hover:text-white">
          ...
          {/* Phone Card */}
          <div className="hidden md:flex group flex-col w-[90%] md:w-[350px] h-[200px] bg-greenCustom shadow-lg rounded-lg p-6 text-white transition-transform hover:-translate-y-2 duration-500 hover:bg-orangeCustom">
