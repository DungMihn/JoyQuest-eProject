...
const ToogleContent: React.FC<Ttitle> = ({ title }) => {
  ...
  return (
    <>
      <div
        className={` border-[1px] border-greenCustom rounded-2xl hover:cursor-pointer overflow-hidden relative ${
      ...
      >
        ...
        >
          <div
            className={`text-[17px] items-center ${
        ...
        <div className={`${openIndexes ? "visible" : "hidden"}`}>
          <p className="overflow-hidden p-4 bg-white font-outfit">
