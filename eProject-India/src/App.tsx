    ...
    <div className="relative">
      ...
      <Routes>
        <Route path="" element={<MainLayout />}>
          ...
          <Route path="/activities/womens-games" element={<D_FemalesPage />} />
          <Route path="/activities/childrens-games" element={<D_KidsPage />} />
          <Route path="/activities/mens-games" element={<D_MalesPage />} />
