...
export const ButtonBooking: React.FC<ButtonProps> = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="flex items-center justify-center bg-[#f2682a] text-[#fff] font-medium py-[12px] px-[24px] rounded-full transition-transform duration-300 hover:bg-[#5b9a42] hover:text-white hover:-translate-y-1 border-none text-[15px]"
    >
