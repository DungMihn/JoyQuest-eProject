  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ backgroundImage: 'url("https://duruthemes.com/demo/html/bycamp/img/slider/03.jpg")' }}
      >
      ...
      <section
        ...
        style={{ backgroundImage: 'url("https://duruthemes.com/demo/html/bycamp/img/activities/1.jpg")' }}
      >
