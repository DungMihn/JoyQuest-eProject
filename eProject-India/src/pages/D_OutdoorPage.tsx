  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ backgroundImage: 'url("https://duruthemes.com/demo/html/bycamp/img/activities/2.jpg")' }}
      >
        <div className="bg-black bg-opacity-30 w-full h-full flex justify-center items-center">
          <h3 className="text-3xl md:text-5xl text-white">Outdoor Activities</h3>
        </div>
      </div>
      ...
      <section
        ...
        style={{ backgroundImage: 'url("https://duruthemes.com/demo/html/bycamp/img/slider/01.jpg")' }}
      >
