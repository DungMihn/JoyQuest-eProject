    ...
    <>
        ...
        <div className="container pt-16">
          <div className="row justify-content-center column-gap-4">
            <div className="col-5">
              ...
              />
              <h1 className="mb-5">About the byCamp</h1>
              <p className="text-xl">
            ...
            <div className="col-5">
              <div className="overflow-hidden position-relative isolate rounded">
      ...
      <section className="bg-neutral-100">
        <div className="container">
          ...
          <div className="flex justify-content-center column-gap-4">
            <div className="H-button col-4 h-32 flex justify-content-center">
              <span>
      ...
      <section className="">
        <div>
          ...
          <div className="H-slider-container2 mx-auto col-lg-6 col-md-12 text-center">
            <Slider {...settings2}>
              <div>
                <h3>1</h3>
              </div>
